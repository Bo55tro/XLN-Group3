...
const CaseCreationpage = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:5014/api/cases/categories", {
            method: "GET",
    ...
    useEffect(() => {
        ...
        setReasons([]);
        if (selectedCategory) {
            fetch(`http://localhost:5014/api/cases/reasons/${selectedCategory}`, {
                method: "GET",
                headers: { "Accept": "application/json" }
            })
                .then((res) => res.json())
    ...
    useEffect(() => {
        if (selectedReason) {
            fetch(`http://localhost:5014/api/cases/details/${selectedReason}`, {
                method: "GET",
                headers: { "Accept": "application/json" }
            })
                .then((res) => res.json())
    ...
    useEffect(() => {
        fetch("http://localhost:5014/api/cases/clients")
            .then((res) => res.json())
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:5014/api/cases/create", {
                method: "POST",
                headers: {
